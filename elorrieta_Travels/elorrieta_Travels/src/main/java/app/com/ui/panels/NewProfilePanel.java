...
/**
 * La clase de Panel del panel NewProfile
 * 
 * @author Grupo_01
 */
public class NewProfilePanel extends JPanel {
	...
	/**
	 * Obtiene el campo de entrada del nombre de la agencia.
	 * 
	 * @return Retorna `JTextField` 
	 */
	...
	/**
	 * Obtiene el campo de entrada de la contraseña de la agencia.
	 * 
	...
	/**
	 * Obtiene el campo de entrada del color de la agencia en formato hexadecimal.
	 * 
	 * @return Retorna un `JTextField`
	 */
	...
	/**
	 * Obtiene el campo de selección para el número de empleados de la agencia.
	 * 
	 * @return Retorna un `CustomComboBox` 
	 */
	...
	/**
	 * Obtiene el campo de selección para el tipo de agencia.
	 * 
	 * @return Retorna un `CustomComboBox`
	 */
	...
	/**
	 * Obtiene el campo de entrada para la URL del logo de la agencia.
	 * 
	 * @return Retorna un  `JTextField`
	 */
	 ...
	 * 
	 * @return Retorna un `CustomUsualButton`
	 */
