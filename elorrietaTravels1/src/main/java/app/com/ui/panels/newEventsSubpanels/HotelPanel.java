...
public class HotelPanel extends JPanel{
	...
	public HotelPanel() {
	    	...
	    	roomTypeLabel.setBounds(centerX, startY, labelWidth, labelHeight);
	    	roomTypeLabel.setForeground(Color.BLACK);
	    	roomTypeLabel.setFont(new Font("Arial", Font.BOLD, 20));
	    	
	    	cityLabel.setBounds(centerX, startY + 1 * (labelHeight + verticalSpacing), labelWidth, labelHeight);
	    	cityLabel.setForeground(Color.BLACK);
	    	cityLabel.setFont(new Font("Arial", Font.BOLD, 20));
	    	
	    	priceLabel.setBounds(centerX, startY + 2 * (labelHeight + verticalSpacing), labelWidth, labelHeight);
	    	priceLabel.setForeground(Color.BLACK);
	    	priceLabel.setFont(new Font("Arial", Font.BOLD, 20));
	    	
	    	checkInLabel.setBounds(centerX, startY + 3 * (labelHeight + verticalSpacing), labelWidth, labelHeight);
	    	checkInLabel.setForeground(Color.BLACK);
	    	checkInLabel.setFont(new Font("Arial", Font.BOLD, 20));
	    	
	    	checkOutLabel.setBounds(centerX, startY + 4 * (labelHeight + verticalSpacing), labelWidth, labelHeight);
	    	checkOutLabel.setForeground(Color.BLACK);
	    	checkOutLabel.setFont(new Font("Arial", Font.BOLD, 20));
	    	
	    	roomTypesInput.setBounds(centerX + labelWidth + 10, startY, 300, labelHeight);
	    	cityInput.setBounds(centerX + labelWidth + 10, startY + 1 * (labelHeight + verticalSpacing), 300, labelHeight);
	    	priceInput.setBounds(centerX + labelWidth + 10, startY + 2 * (labelHeight + verticalSpacing), 300, labelHeight);
	    	dateCheckIn.setBounds(centerX + labelWidth + 10, startY + 3 * (labelHeight + verticalSpacing), 300, labelHeight);
	    	dateCheckOut.setBounds(centerX + labelWidth + 10, startY + 4 * (labelHeight + verticalSpacing), 300, labelHeight);
	
	    	searchButton.setBounds(220, 420, searchButton.getWidth()+100, searchButton.getHeight());
